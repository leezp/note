...
在windows装钱包，在矿池 [hpool](https://hpool.com) 下载工具，获取绑定矿池的签名：

![](chia4.jpg)

[将生成的签名绑定矿池](https://hpool.com/center/configuration)
...
p完图自动将 /path/to/temporary/directory 下的文件复制到 /path/to/temporary/directory 目录下：
